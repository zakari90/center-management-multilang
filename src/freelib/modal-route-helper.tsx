...
import { ModalContentWrapper } from "@/components/freeinUse/modal-content-wrapper";

/**
 * Generic wrapper component for any detail page
 * Use this pattern to quickly convert any [id] route to support modals
 */
export function createModalPageWrapper<T = string>(
  ContentComponent: (props: { itemId: T; isModal?: boolean }) => ReactNode,
) {
