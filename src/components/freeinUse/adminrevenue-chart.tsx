...
import { getSemanticColors } from "@/freelib/utils/themeColors";
...
export default function AdminRevenueChart() {
  ...
  const data = useLiveQuery(async () => {
    try {
      ...
      // Use raw Dexie data (direct deletion in local-only mode)
      ...
      const chartData = Array.from(revenueMap.entries()).map(
        ([date, values]) => ({
          date,
