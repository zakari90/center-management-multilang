...
export default function AddReceiptDialog({
  ...
  const fetchStudents = useCallback(async () => {
    try {
      ...
      const adminStudents = allStudents;

      const studentsWithSubjects: Student[] = adminStudents.map((student) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-[1200px] w-auto max-h-[90dvh] flex flex-col p-1">
        <DialogHeader>
                                ...
                                <li key={student.id}>
                                  ...
                                  >
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      {student.grade} •{" "}
                                      {student.studentSubjects.length} subjects
                                    </p>
                                  </button>
                                </li>
                              ))}
