...
export default function CreateStudentForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await router.push("/admin/program/students");
      router.refresh();
    } catch (err: any) {
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {subjectsForGrade.length === 0 ? (
                          <p className="text-muted-foreground col-span-2">
                            {t("enrollmentnoSubjectsForGrade")}
                          </p>
                        ) : (
                              ...
                              <div className="w-full flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground mt-1">
                                    ...
                                    {t("enrollmentteachersAvailable")}
                                  </p>
                                </div>
                                <p className="text-lg font-bold text-primary">
                                  {subject.price.toFixed(2)} درهم
                                </p>
                              </div>
                            </Button>
                          ))
                          ...
                          <div className="flex-1">
                            <div className="flex items-start gap-3">
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                  {t("enrolledSubjectsgradeLabel")}: {es.grade}{" "}
                                  | {t("enrolledSubjectsteacherLabel")}:{" "}
                                  {es.teacherName}
                                </p>
                              </div>
                              <div className="text-right">
                                <p className="text-lg font-bold text-primary">
                                  {es.price.toFixed(2)} درهم
                                </p>
                              </div>
                            </div>
                          </div>
