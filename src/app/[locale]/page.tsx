  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute top-[20%] -left-[20%] w-[70vw] h-[70vw] rounded-full bg-blue-400/20 mix-blend-multiply filter blur-[120px] animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
        <div className="absolute -bottom-[20%] left-[20%] w-[60vw] h-[60vw] rounded-full bg-violet-400/20 mix-blend-multiply filter blur-[100px] animate-pulse-slow" style={{ animationDelay: '4s' }}></div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row relative z-10 container mx-auto px-6 pt-24 pb-32">
        <div className="flex-1 flex justify-center lg:items-center">
          ...
          >
            ...
            {/* Typography Section */}
            <div className="space-y-4 w-full animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <div className="animate-fade-in-up w-full mt-8" style={{ animationDelay: '200ms' }}>
              <div className="relative p-px rounded-2xl bg-linear-to-b from-white/60 to-white/10 overflow-hidden group">
                ...
                <div className={`absolute top-0 bottom-0 w-2 ${isRtl ? 'right-0' : 'left-0'} bg-linear-to-b from-indigo-500 to-blue-500`}></div>
        ...
        <div className="flex-1 relative flex items-center justify-center mt-12 lg:mt-0 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
      ...
      <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center px-4 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
        <div className="flex items-center gap-6 px-6 sm:px-8 py-3.5 bg-white/70 backdrop-blur-2xl border border-white/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.2)] rounded-full hover:bg-white/80 transition-colors duration-300">
          ...
          {content.phone && (
            <button
              onClick={() => window.open(`https://wa.me/${content.phone?.replace(/\D/g, "")}`, "_blank")}
            ...
            >
              ...
              <span className="text-xl font-bold font-mono text-slate-700 tracking-wider transform translate-y-px">{content.phone}</span>
            </button>
          )}
          ...
          {content.address && (
            <div className="hidden sm:flex items-center gap-2 group cursor-default">
              ...
              <span className="text-[15px] font-bold text-slate-600 whitespace-nowrap transform translate-y-px">{content.address}</span>
            </div>
          )}
        </div>
      </div>
