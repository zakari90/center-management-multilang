...
import type { EntityStatus, CompensationType, PaymentMethod, ParsedScheduleEntry } from './common'
...
export interface ActivityLog extends BaseEntity {
  type: 'student' | 'teacher' | 'enrollment' | 'payment' | 'center_created' | 'manager_added' | 'student_enrolled' | 'payment_received'
  title: string
  description: string
  date: string
  link?: string
